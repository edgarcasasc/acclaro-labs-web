  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-4 md:p-6 
        ...
        <div className="flex items-center gap-4">
          {/* CTA DESKTOP: Apunta a la Estrategia/Auditoría */}
          <Link 
      ...
      {/* OVERLAY DE MENÚ MÓVIL (Blog Removido) */}
      {isMenuOpen && (
        <div 
        ...
        >
          ...
          {/* Enlaces a Servicios Específicos en Móvil */}
          ...
          {/* Blog (Eliminado de la navegación) */}
