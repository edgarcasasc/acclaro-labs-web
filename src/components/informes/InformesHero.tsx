...
import { ArrowRight, BarChart3, Activity, PieChart, LucideIcon } from 'lucide-react'; // 1. Importamos LucideIcon

// Mantenemos tus imports de gráficos
...
// --- 2. CORRECCIÓN AQUÍ: Cambiamos React.ElementType por LucideIcon ---
const GlassCard = ({ 
  children, 
  className, 
  delay, 
  ...
  >
    <div className="flex items-center justify-between border-b border-white/5 px-4 py-3">
        <div className="flex items-center gap-2">
            {/* Ahora TypeScript sabe que Icon puede recibir size */}
